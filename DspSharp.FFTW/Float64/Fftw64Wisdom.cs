namespace DspSharp.FFTW.Float64
{
    ...
    /// </remarks>
    public sealed class Fftw64Wisdom : IDisposable
    {
        ...
        public Fftw64Wisdom( string filename )
        {
        ...
        public static void Save( string filename )
        {
            ...
            {
                NativeMethods64.ExportWisdom( filename );
            }
        }
        ...
        public static void Load( string filename )
        {
            lock( Fftw64ApiLock.Lock )
            {
                NativeMethods64.ImportWisdom( filename );
            }
        }
    }
}